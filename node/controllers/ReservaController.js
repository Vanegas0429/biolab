...
export const cambiarEstadoReserva = async (req, res) => {
    try {
        const { Id_Estado, Mot_RecCan, reactivosUtilizados, materialesUtilizados, equiposObservaciones } = req.body;
        await ReservaService.cambiarEstado(req.params.id, Id_Estado, Mot_RecCan, reactivosUtilizados, materialesUtilizados, equiposObservaciones);
